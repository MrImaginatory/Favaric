...
const addAddressSchema = z.object({
    body: z.object({
        addressLine1: z.string().min(15, "Address line 1 must be at least 15 characters long").max(255, "Address line 1 must be at most 255 characters long"),
        addressLine2: z.string().min(15, "Address line 2 must be at least 15 characters long").max(255, "Address line 2 must be at most 255 characters long"),
...
const editAddressSchema = z.object({
    body: z.object({
        ...
        addressLine2: z.string().min(15, "Address line 2 must be at least 15 characters long").max(255, "Address line 2 must be at most 255 characters long").optional(),
