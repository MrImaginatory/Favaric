...
brandRouter.post("/addBrand", upload("brands").single("brandLogo"), validate(createBrandValidation), createBrand);
brandRouter.get("/getBrands", getBrands);
brandRouter.get("/getBrand/:id", validate(uuidValidation), getBrandById);
brandRouter.patch("/updateBrand/:id", upload("brands").single("brandLogo"), validate(updateBrandValidation), updateBrand);
brandRouter.delete("/deleteBrand/:id", validate(uuidValidation), deleteBrand);
brandRouter.get("/searchBrand", searchBrands);
